...
use k256::{ecdsa::SigningKey, elliptic_curve::sec1::ToCompactEncodedPoint, PublicKey, SecretKey};
use rand::Rng;
...
pub(crate) struct RLPxLocalClient {
    ...
    pub(crate) auth_message: Option<HandshakeData>,
}
...
impl RLPxLocalClient {
    ...
    /// Decodes an Ack messge, completing a handshake.
