...
use bytes::Bytes;
use reec_core::types::{Account, AccountInfo, BlockHash, BlockBody, BlockHeader, BlockNumber, Index, Receipt, Transaction};
...
pub trait StoreEngine: Debug + Send {
    ...
    /// Add block header
    fn add_block_header(&mut self, block_number: BlockNumber, block_header: BlockHeader) -> Result<(), StoreError>;
