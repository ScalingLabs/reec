...
impl Store {
    ...
    pub fn get_nonce_by_account_address(&self, address: Address) -> Result<Option<u64>, StoreError> {
        self.engine.clone().lock().unwrap().get_nonce_by_account_address(address)
    }
