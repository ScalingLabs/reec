...
use bytes::Bytes;
use reec_core::types::{BlockBody, BlockHash, BlockHeader, BlockNumber, ChainConfig, Index, Receipt};
...
pub struct Store {
    ...
    transaction_pool: HashMap<BlockHash, HashMap<Index, Receipt>>,
...
impl StoreEngine for Store {
    ...
    fn add_transaction_location(
        ...
        self.transaction_locations.entry(transaction_hash).or_default().push((block_number, block_hash, index));
        Ok(())
    }
