...
impl Node {
    ...
    pub fn get(&self, state: &TrieState, path: NibbleSlice) -> Result<Option<ValueRLP>, StoreError> {
        match self {
    ...
    pub fn insert_self(self, path_offset: usize, state: &mut TrieState) -> Result<NodeHash, StoreError> {
        match self {
