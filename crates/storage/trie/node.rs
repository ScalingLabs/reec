...
impl Node {
    ...
    pub fn get<DB: TrieDB>(&self, state: &TrieState<DB>, path: NibbleSlice) -> Result<Option<ValueRLP>, StoreError> {
        match self {
    ...
    pub fn insert_self<DB: TrieDB>(self, path_offset: usize, state: & mut TrieState<DB>) -> Result<NodeHash, StoreError> {
        match self {
