...
impl BranchNode {
    ...
    pub fn get(&self, state: &TrieState, mut path: NibbleSlice) -> Result<Option<ValueRLP>, StoreError> {
    ...
    pub fn insert_self(self, state: &mut TrieState<DB>) -> Result<NodeHash, StoreError> {
