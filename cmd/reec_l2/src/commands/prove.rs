use clap::Args;
use reec_l2::utils::test_data_io::{generate_program_input, read_chain_file, read_genesis_file};
use reec_prover_lib::prover::create_prover;
...
impl Command {
    pub fn run(self) -> eyre::Result<()> {
        ...
        let mut prover = create_prover(reec_l2::proposer::prover_server::ProverType::RISC0);
