...
async fn main() {
    ...
    let http_addr = matches.get_one::<String>("http.addr").expect("http.addr is required");
    ...
    let authrpc_jwtsecret = matches.get_one::<String>("authrpc.jwtsecret").expect("authrpc.jwtsecret is required");
